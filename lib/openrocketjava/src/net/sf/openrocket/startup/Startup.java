...
public class Startup {
	...
	public static final String LOG_STDERR_PROPERTY = "openrocket.log.stderr";
	public static final String LOG_STDOUT_PROPERTY = "openrocket.log.stdout";
	
	public static final int LOG_BUFFER_LENGTH = 50;
	...
	public static boolean setLogOutput(PrintStreamLogger logger, PrintStream stream, String level, LogLevel defaultLevel) {
