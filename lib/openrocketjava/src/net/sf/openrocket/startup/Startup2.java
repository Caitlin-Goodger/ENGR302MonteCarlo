...
public class Startup2 {
	public static final LogHelper log = Application.getLogger();
	

	public static final String THRUSTCURVE_DIRECTORY = "datafiles/thrustcurves/";
	
	/** Block motor loading for this many milliseconds */
	public static AtomicInteger blockLoading = new AtomicInteger(Integer.MAX_VALUE);
	 ...
	 * @param args	command line arguments
	 */
	public static void runInEDT(String[] args) {
	...
	public static void checkUpdateStatus(final UpdateInfoRetriever updateInfo) {
		if (updateInfo == null)
			return;
